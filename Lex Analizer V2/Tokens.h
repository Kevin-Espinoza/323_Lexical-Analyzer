...
struct Tokens
{
    // these are the category id numbers, each is distinct
    const int keyword_category = 0;
    const int identifier_category = 1;
    // the others were omited because they are not being used yet
